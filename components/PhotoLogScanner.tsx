...
import { X, Camera, AlertCircle, Loader2, Sparkles, RefreshCw } from 'lucide-react';
...
const PhotoLogScanner: React.FC<PhotoLogScannerProps> = ({ isOpen, onClose, onCapture, isAnalyzing }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black flex flex-col items-center justify-center p-4">
                    ...
                    <>
                        ...
                        {isAnalyzing && (
                            <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center backdrop-blur-sm z-20">
                                ...
                                <p className="text-zinc-400 text-xs mt-1 italic">Identifying food, drinks & macros</p>
            ...
            {/* Controls */}
            {!isAnalyzing && !error && (
                <div className="w-full max-w-md pt-12 flex flex-col items-center gap-8 px-6">
